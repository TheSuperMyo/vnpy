...
class TSMyoDLLTStrategy(CtaTemplate):
    ...
    parameters = ['LLT_len_slow','LLT_len_fast','fit_bar','trailing_stop','fixed_size']
    variables = ['bar_counter','LLT_value_slow','LLT_value_fast','stop_long','stop_short','hold_high','hold_low','cross_up','cross_down']

    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        """"""
        super(TSMyoDLLTStrategy, self).__init__(
